...
const Icon = styled.img`
  ...
  &:hover {
    filter: brightness(0) saturate(100%) invert(80%) sepia(78%) saturate(4678%)
      hue-rotate(357deg) brightness(99%) contrast(108%);
  }
`;
...
const ImgLink = (props) => {
  if (!props.link) {
    return <StaticIcon src={props.img} alt="" width={props.width} />;
  }
  return (
